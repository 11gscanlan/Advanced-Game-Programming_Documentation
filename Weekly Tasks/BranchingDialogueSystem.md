...
For this task I was in a group of 3 with Cayleen and Ben. We were asked to use C# for this task, so I had literally no clue what we were doing most of the time. Cayleen and Ben took a stronger role in working on the task and I felt I wasn't doing as much as I could've done in the task. I did suggest some solutions to compiler errors we were having, but the final code was largely by them.
